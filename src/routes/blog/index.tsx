              ...
              {articles.map((post) => (
                <StaggerItem key={post.id} className="flex">
                  <Link
                    ...
                    className="group w-full rounded-2xl overflow-hidden border border-border bg-card text-left hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 flex flex-col"
                  >
