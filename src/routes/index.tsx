  ...
  return (
    <SiteLayout>
      ...
      <section className="relative overflow-hidden">
        ...
        <Reveal className="relative z-10 max-w-7xl mx-auto px-6 py-24">
          <div className="relative overflow-hidden rounded-3xl border-2 border-blue-500/30 p-12 md:p-20 text-center" style={{ background:"linear-gradient(135deg,#0a0e1a 0%,#1a1f35 100%)", boxShadow:"0 0 80px rgba(66,133,244,0.2)" }}>
            ...
            <div className="relative">
              ...
              <h2 className="mt-3 text-3xl md:text-5xl font-bold tracking-tight text-white">Partner with DevdigitaX and scale your business.</h2>
